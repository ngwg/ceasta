...
static const std::vector<action>& actions()
{
    static const std::vector<action> list = {
        ...
        {"File", "Import names (IDA, Ghidra, x64dbg, .map) or a C header...", "", has_file, [](app_state& s) { app_import_names(s); }},
        ...
        {"Edit", "C types: structs, unions, enums, typedefs...", "Shift+F1", has_file, [](app_state& s) { open_dialog(s, dialog_kind::types); }},
